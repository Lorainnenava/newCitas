  ...
  implements IMedicalAppointmentApplication
{
  constructor(
    ...
    private codeRandomService: CodeRandomService,
    private descriptionService: DescriptionService,
    private dateService: DateService,
    private patientService: PatientService,
    private doctorService: DoctorService,
    private objectEntriesService: ObjectEntriesService,
    private confirmationMedicalAppointmentService: ConfirmationMedicalAppointmentService,
  ) {}
   ...
   * @param user
   */
  async create(@Body() request: MedicalAppointmentRequestDto): Promise<object> {
    try {
